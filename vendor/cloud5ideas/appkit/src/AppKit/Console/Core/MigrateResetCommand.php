...
class MigrateResetCommand extends Command
{
	 ...
	 */
	protected $name = 'appkit:migrate:reset';

	/**
	 * @var string $description The console command description.
	 */
	protected $description = 'Rollback all application and module migrations.';
	...
	{
		return $this->handler->fire($this, 'reset', $this->getFormattedOptions());
	}
