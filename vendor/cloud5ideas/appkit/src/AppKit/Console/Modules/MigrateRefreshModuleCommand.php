 ...
 */
class MigrateRefreshModuleCommand extends Command
{
	/**
	 * @var string $name The console command name.
	 */
	protected $name = 'appkit:migrate:refresh:module';
	...
	public function fire()
	{
		...
		$this->call('appkit:migrate:reset:module', [
			'module'     => $module,
		...
		$this->call('appkit:migrate:module', [
			'module'     => $module,
			'--database' => $this->option('database')
		]);
